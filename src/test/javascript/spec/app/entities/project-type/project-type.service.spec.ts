...
describe('Service Tests', () => {
    describe('ProjectType Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new ProjectType(0, 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a ProjectType', async () => {
            ...
            it('should update a ProjectType', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB'
                    },
            ...
            it('should return a list of ProjectType', async () => {
                const returnedFromService = Object.assign(
                    {
                        name: 'BBBBBB'
                    },
            ...
            it('should delete a ProjectType', async () => {
