...
import { CorrespondenceComponent } from 'app/entities/correspondence/correspondence.component';
...
describe('Component Tests', () => {
    describe('Correspondence Management Component', () => {
        let comp: CorrespondenceComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.correspondences[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
