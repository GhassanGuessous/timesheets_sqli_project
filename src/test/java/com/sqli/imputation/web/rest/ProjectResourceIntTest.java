...
import com.sqli.imputation.repository.ProjectRepository;
import com.sqli.imputation.service.ProjectService;
...
public class ProjectResourceIntTest {
    ...
    private static final String DEFAULT_AGRESSO = "AAAAAAAAAA";
    private static final String UPDATED_AGRESSO = "BBBBBBBBBB";
    ...
    public void createProject() throws Exception {
        ...
        assertThat(testProject.getAgresso()).isEqualTo(DEFAULT_AGRESSO);
    ...
    public void getAllProjects() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].agresso").value(hasItem(DEFAULT_AGRESSO.toString())))
    ...
    public void getProject() throws Exception {
        ...
        restProjectMockMvc.perform(get("/api/projects/{id}", project.getId()))
            ...
            .andExpect(jsonPath("$.agresso").value(DEFAULT_AGRESSO.toString()))
    ...
    public void updateProject() throws Exception {
        ...
        Project testProject = projectList.get(projectList.size() - 1);
        assertThat(testProject.getAgresso()).isEqualTo(UPDATED_AGRESSO);
